...
interface DecodeMessageCw721TransferProps extends TxMsgData {
  decodedMessage: DecodedMessage & {
    action: "cw721_transfer";
  };
}

export const DecodeMessageCw721Transfer = memo(
  ({
    compact,
    decodedMessage,
    log,
    msgBody,
    msgCount,
  }: DecodeMessageCw721TransferProps) => {
