...
describe("parseStateKey", () => {
  ...
  it("should parse a bucket key with tuple value", () => {
    const key =
      "0005636F6C6C7300135B226173646B617364222C2268656C6C6F225D6962632F32373339344642303932443245434344353631323343373446333645344331463932363030314345414441394341393745413632324232354634314535454232";
    expect(parseStateKey(key)).toEqual({
      type: "bucket",
      values: [
        "colls",
