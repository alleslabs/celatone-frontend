...
export enum CELATONE_QUERY_KEYS {
  ...
  NFT_COLLECTION_MUTATE_EVENTES = "CELATONE_QUERY_NFT_COLLECTION_MUTATE_EVENTES",
  NFT_TOKEN_INFO = "CELATONE_QUERY_NFT_TOKEN_INFO",
  NFT_TOKEN_LIST = "CELATONE_QUERY_NFT_TOKEN_LIST",
  NFT_TOKEN_MINT_INFO = "CELATONE_QUERY_NFT_TOKEN_MINT_INFO",
  NFT_TOKEN_MUTATE_EVENTS = "CELATONE_QUERY_NFT_TOKEN_MUTATE_EVENTS",
