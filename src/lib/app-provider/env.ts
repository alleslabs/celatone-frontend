...
export enum CELATONE_QUERY_KEYS {
  ...
  // NFTS
  NFT_COLLECTIONS_PAGINATION = "CELATONE_QUERY_NFT_COLLECTIONS_PAGINATION",
  NFT_COLLECTION_TOTAL_BURNED = "CELATONE_QUERY_NFT_COLLECTION_TOTAL_BURNED",
  NFT_COLLECTION_BY_ADDRESS = "CELATONE_QUERY_NFT_COLLECTION_BY_ADDRESS",
  ...
  NFT_COLLECTION_MUTATE_EVENTES_COUNT = "CELATONE_QUERY_NFT_COLLECTION_MUTATE_EVENTES_COUNT",
  NFT_COLLECTION_UNIQUE_HOLDERS_COUNT = "CELATONE_QUERY_NFT_COLLECTION_UNIQUE_HOLDERS_COUNT",
  NFT_COLLECTION_ACTIVITIES_PAGINATION = "CELATONE_QUERY_NFT_COLLECTION_ACTIVITIES_PAGINATION",
  NFT_COLLECTION_MUTATE_EVENTES_PAGINATION = "CELATONE_QUERY_NFT_COLLECTION_MUTATE_EVENTES_PAGINATION",
  NFT_COLLECTION_LIST_BY_ADDRESS = "CELATONE_QUERY_NFT_COLLECTION_LIST_BY_ADDRESS",
  NFT_TOKEN_COUNT_BY_ADDRESS = "CELATONE_QUERY_NFT_TOKEN_COUNT_BY_ADDRESS",
  NFT_TOKEN_INFO = "CELATONE_QUERY_NFT_TOKEN_INFO",
  NFT_TOKEN_LIST_PAGINATION = "CELATONE_QUERY_NFT_TOKEN_LIST_PAGINATION",
  NFT_TOKEN_LIST_BY_COLLECTION_BY_ADDRESS_PAGINATION = "CELATONE_QUERY_NFT_TOKEN_LIST_BY_COLLECTION_BY_ADDRESS_PAGINATION",
  NFT_TOKEN_LIST_BY_ADDRESS = "CELATONE_QUERY_NFT_TOKEN_LIST_BY_ADDRESS",
  NFT_TOKEN_LIST_BY_ADDRESS_PAGINATION = "CELATONE_QUERY_NFT_TOKEN_LIST_BY_ADDRESS_PAGINATION",
  NFT_TOKEN_MINT_INFO = "CELATONE_QUERY_NFT_TOKEN_MINT_INFO",
  NFT_TOKEN_MUTATE_EVENTS_PAGINATION = "CELATONE_QUERY_NFT_TOKEN_MUTATE_EVENTS_PAGINATION",
  NFT_TOKEN_MUTATE_EVENTS_COUNT = "CELATONE_QUERY_NFT_TOKEN_MUTATE_EVENTS_COUNT",
  NFT_TOKEN_TRANSACTION_PAGINATION = "CELATONE_QUERY_NFT_TOKEN_TRANSACTION_PAGINATION",
  NFT_TOKEN_TRANSACTION_COUNT = "CELATONE_QUERY_NFT_TOKEN_TRANSACTION_COUNT",
