...
export const useInstantiatedCountByUserQuery = (
  ...
  return useQuery(
    ["instantiated_count_by_user", walletAddr, currentChainRecord],
    queryFn,
    {
...
export const useInstantiatedListByUserQuery = (
  ...
  return useQuery(
    ["instantiated_list_by_user", walletAddr, currentChainRecord],
    queryFn,
    {
      keepPreviousData: true,
      enabled: !!walletAddr,
...
export const useContractListByAdmin = (
  ...
  return useQuery(
    ["contract_list_by_admin", adminAddress, currentChainRecord],
    queryFn,
    {
      keepPreviousData: true,
...
export const useInstantiateDetailByContractQuery = (
  ...
  return useQuery(
    ["instantiate_detail_by_contract", contractAddress, currentChainRecord],
    queryFn,
    {
      keepPreviousData: true,
    }
...
export const useAdminByContractAddresses = (
  ...
  return useQuery(
    ["admin_by_contracts", contractAddresses, currentChainRecord],
    queryFn,
    {
      keepPreviousData: true,
...
export const useMigrationHistoriesCountByContractAddress = (
  ...
  return useQuery(
    ["migration_histories_count", contractAddress, currentChainRecord],
    queryFn,
    {
      keepPreviousData: true,
      enabled: !!contractAddress,
...
export const useRelatedProposalsCountByContractAddress = (
  ...
  return useQuery(
    ["related_proposals_count", contractAddress, currentChainRecord],
    queryFn,
    {
      keepPreviousData: true,
      enabled: !!contractAddress,
