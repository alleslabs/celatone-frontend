...
export const minitiatestnets: Chain[] = [
  ...
  },
  {
    ...
    status: "live",
    network_type: "testnet",
    pretty_name: "Free Minitia Testnet",
    chain_id: "free-3",
    bech32_prefix: "init",
    daemon_name: "initiad",
    node_home: "$HOME/.init",
    ...
    apis: {
      rpc: [
        {
          address: "https://free-3-minitia-rpc.initia.tech",
        },
      ],
      rest: [
        {
          address: "https://free-3-minitia-rest.initia.tech",
        },
      ],
    },
  },
  {
    ...
    status: "live",
    network_type: "testnet",
    pretty_name: "Wasm Minitia Testnet",
    chain_id: "wasm-3",
    bech32_prefix: "init",
    daemon_name: "initiad",
    node_home: "$HOME/.init",
    ...
    apis: {
      rpc: [
        {
          address: "https://wasm-3-minitia-rpc.initia.tech",
        },
      ],
      rest: [
        {
          address: "https://wasm-3-minitia-rest.initia.tech",
        },
      ],
    },
  },
