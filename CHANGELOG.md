...
- [#1281](https://github.com/alleslabs/celatone-frontend/pull/1281) Add advanced options helper text, and limit fetching verification infos to hex addresses only
